...
- YAML: 2 spaces padding
- JSON: 4 spaces padding
...
1. Ensure any install or build dependencies are removed before the end of the layer when doing a
   build.
2. Update the CHANGELOG.md with details of changes, this includes new environment variables, exposed ports,
...
reported by contacting the project team at spam312sn@gmail.com. All
